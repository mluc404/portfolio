  ...
  return (
    <div className="flex flex-col px-6 py-8 gap-8 md:gap-20 md:px-20 md:py-24 ">
      ...
      <div id="about" className="flex flex-col gap-4">
        <div>ABOUT</div>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus quas eos,
        obcaecati animi temporibus dolor ea facere maxime necessitatibus
        perspiciatis nam, tenetur voluptate exercitationem corrupti cupiditate
        voluptatem itaque repellendus sapiente.
      </div>
